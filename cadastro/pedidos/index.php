...
<body class="hold-transition skin-blue sidebar-mini" onLoad="consultar_pedidos()">
<div class="wrapper">
  ...
  <div class="content-wrapper">
   ...
   <section class="content-header">
    ...
    <ol class="breadcrumb">
        ...
        <li><a href="../../cadastro/pedidos">Pedidos</a></li>
 ...
 <div class="row">
   <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
        ...
        <div class="container-fluid">
         <div class="row">
          ...
          <div class="form-group">
           ...
           <div class="form-group">
            <input type="text" class="form-control control-label" style="width:100px" id="pedido">
             </div>
          <div class="form-group">
          <button id="btn_pedido" type="button" class="btn btn-default"><span class="glyphicon glyphicon-search"></span></button>   
                 </div>
        ...
        <div class="input-group date" style="width:140px;" >
			<input class="form-control" name="datainicial" id="datainicial" type="text">
       ...
       <div class="form-group">	
        <div class="input-group date" style="width:140px;" >
			<input class="form-control" name="datafinal" id="datafinal" type="text">
			<span class="input-group-addon"><i class="fa fa-calendar"></i></span>
		</div>
       </div>
        <div class="form-group">
	...
	<div class="form-group">
            <label class="control-label col-sm-4">Produto:</label>
            </div>
           <div class="form-group">
            <select class="produto form-control" name="produto" id="produto" style="width:250px;" required>
					</select> 
                    <button type="button" class="btn btn-default"><span class="glyphicon glyphicon-search"></span></button>  
             </div>
    ...
    <div class="modal-dialog modal-lg">
      <div class="modal-content">
        <div class="modal-header">
          ...
          <h4 class="modal-title" style="color:black">Adicionar uma Categoria</h4>
        </div>
            ...
            <div class="row">
              <div class="col-md-7">
               <div class="form-group">
                  ...
                  <input id="nomecategoria" type="text" name="nomecategoria"  class="form-control">    
               </div>
                  ...
                  <div class="pull-right">
                    ...
                    <div id="carregando"  style="display:none;float:right;margin-right:-10px;margin-top:10px;">
                             ...
                             <div class="alert-success" id="sucesso" style="font-size:14px;width:100%;height:30px;margin-top:10px;">
                                <strong>Categoria Gravado com Sucesso!!!</strong>
                             </div>
  ...
  <div class="modal fade" id="altera_modal" role="dialog">
    <div class="modal-dialog modal-lg">
      <div class="modal-content">
        <div class="modal-header">
          <button type="button" class="close" data-dismiss="modal">&times;</button>
          <h4 class="modal-title" style="color:black">Editar uma Categoria</h4>
        </div>
        <div class="modal-body">
           <form id="frmalterarcategorias" name="frmalterarcategorias"  method="post">
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        ...
        <h4 class="modal-title">Excluir Pedidos?</h4>
      </div>
      <div class="modal-body">
      ...
      <div class="modal-footer">
        ...
        <div id="carregaexcluir"  style="display:none;float:right;margin-right:-10px;margin-top:10px;">
                             ...
                             <div class="alert-success" id="excluirsucesso" style="font-size:14px;width:100%;height:30px;margin-top:10px;">
                                <strong>Pedido excluido com Sucesso!!!</strong>
                             </div>
...
$(document).ready(function() {
    $( ".produto" ).select2({        
    ajax: {
        url:"controller.php?acao=filtrarproduto",
        dataType: 'json',
        delay: 250,
	   ...
	   $('#btn_excluir').on('click', function (e)
	{
	 ...
	 $(document).ready(function()
       ...
       $("#altera_modal #alterarsucesso").hide();
	    ...
	    $('#altera_modal').on('shown.bs.modal', function ()
		{
			...
			//var codigo            =  $("#codigo").val();
			   ...
			   var nomecategoria     = $("#altera_modal #nomecategoria").val();
			   var Descricao         = $("#altera_modal #descricao").val();
	  ...
	  $("#tabela_body").on('click','[data-action="shred"]',function (e)
	  {
		...
		var nomecategoria     = $(this).attr('data-nome');
		var Descricao         = $(this).attr('data-descricao');
		
		$("#altera_modal input[name='codigo']").val(codigo); 
		$("#altera_modal input[name='nomecategoria']").val(nomecategoria);
		
		$("#altera_modal input[name='descricao']").val(Descricao);
		
		$("#altera_modal input[name='nomecategoria']").focus();
        ...
        
	  {
	   ...
	   if(nomecategoria == '')
		...
		$("#altera_modal #alterarsucesso").hide();
		var form=$("#frmalterarcategorias");
			var dados = $('#frmalterarcategorias').serialize();
...
$(document).ready(function()
   {
	...
	$('#btn_salvar').on('click', function (e)
	{
	   ...
	   var carregando        =  $("#carregando").val();
		...
		$("#sucesso").hide();
		  var form=$("#frmcategorias");
			var dados = $('#frmcategorias').serialize();
	  ...
	  $('#btn_pedido').on('click', function (e)
	   {
		e.preventDefault();
	    var pesquisa  =  $("#pedido").val();
