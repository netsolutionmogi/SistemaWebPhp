...
<body class="hold-transition skin-blue sidebar-mini" onLoad="consultar_vendedor()">
<div class="wrapper">
  ...
  <div class="content-wrapper">
   ...
   <section class="content-header">
    ...
    <ol class="breadcrumb">
        ...
        <li><a href="../../cadastro/vendedor">Vendedor</a></li>
    ...
    <div class="modal-dialog modal-lg">
      <div class="modal-content">
        <div class="modal-header">
          ...
          <h4 class="modal-title" style="color:black">Adicionar um Vendedor</h4>
        </div>
             ...
             <div class="col-md-2">
               <div class="form-group">
                  <label for="DataNasc">Data Nasc *</label>
                    <input id="DataNasc" type="text" name="DataNasc" onkeypress="MascaraData(DataNasc)" maxlength="10"  class="form-control">                
               </div>
            </div>
            <div class="col-md-2">
               <div class="form-group">
           ...
           <div class="col-md-3">
            ...
            <div class="col-md-3">
               <div class="form-group">
                  ...
                  <input id="DataAdmissao" type="text" name="DataAdmissao" onkeypress="MascaraData(DataAdmissao)" maxlength="10"  class="form-control">
               </div>   
            </div>
          </div>
                  ...
                  <div class="pull-right">
                    ...
                    <div id="carregando"  style="display:none;float:right;margin-right:-10px;margin-top:10px;">
                             ...
                             <div class="alert-success" id="sucesso" style="font-size:14px;width:100%;height:30px;margin-top:10px;">
                                <strong>Vendedor Gravado com Sucesso!!!</strong>
                             </div>
  ...
  <div class="modal fade" id="altera_modal" role="dialog">
    <div class="modal-dialog modal-lg">
      <div class="modal-content">
        <div class="modal-header">
          <button type="button" class="close" data-dismiss="modal">&times;</button>
          <h4 class="modal-title" style="color:black">Editar um Vendedor</h4>
        </div>
        <div class="modal-body">
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        ...
        <h4 class="modal-title">Excluir Funcionarios?</h4>
      </div>
      <div class="modal-body">
      ...
      <div class="modal-footer">
        ...
        <div id="carregaexcluir"  style="display:none;float:right;margin-right:-10px;margin-top:10px;">
                             ...
                             <div class="alert-success" id="excluirsucesso" style="font-size:14px;width:100%;height:30px;margin-top:10px;">
                                <strong>Funcionario excluido com Sucesso!!!</strong>
                             </div>
	   ...
	   $('#btn_excluir').on('click', function (e)
	{
	 ...
	 $(document).ready(function()
       ...
       $("#altera_modal #alterarsucesso").hide();
	    ...
	    $('#altera_modal').on('shown.bs.modal', function ()
		{
			...
			//var codigo            =  $("#codigo").val();
			   ...
			   var DataAdmissao      = $("#altera_modal #DataAdmissao").val();
			   ...
			   var cargo             = $("#altera_modal #cargo").val();			
	  ...
	  $("#tabela_body").on('click','[data-action="shred"]',function (e)
	  {
		...
		var Data          = $(this).attr('data-DataNasc');
		var DataNasc=Data.split("-");
        var DataNascimento = DataNasc[2]+"/"+DataNasc[1]+"/"+DataNasc[0];
		
		$("#altera_modal input[name='DataNasc']").val(DataNascimento);
		
		var DataAd          = $(this).attr('data-admissao');
		var DataAdmi=Data.split("-");
        var DataAdmissao = DataAdmi[2]+"/"+DataAdmi[1]+"/"+DataAdmi[0];
		
		$("#altera_modal input[name='DataAdmissao']").val(DataAdmissao);
		...
		$("#altera_modal input[name='cargo']").val(cargo);
