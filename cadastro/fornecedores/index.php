...
<body class="hold-transition skin-blue sidebar-mini" onLoad="consultar_fornecedores()">
<div class="wrapper">
  ...
  <div class="content-wrapper">
   ...
   <section class="content-header">
    ...
    <ol class="breadcrumb">
        ...
        <li><a href="../../cadastro/fornecedores">Fornecedores</a></li>
    ...
    <div class="modal-dialog modal-lg">
      <div class="modal-content">
        <div class="modal-header">
          ...
          <h4 class="modal-title" style="color:black">Adicionar um Fornecedor</h4>
        </div>
                  ...
                  <div class="pull-right">
                    ...
                    <div id="carregando"  style="display:none;float:right;margin-right:-10px;margin-top:10px;">
                             ...
                             <div class="alert-success" id="sucesso" style="font-size:14px;width:100%;height:30px;margin-top:10px;">
                                <strong>Cliente Gravado com Sucesso!!!</strong>
                             </div>
  ...
  <div class="modal fade" id="altera_modal" role="dialog">
    <div class="modal-dialog modal-lg">
      <div class="modal-content">
        <div class="modal-header">
          <button type="button" class="close" data-dismiss="modal">&times;</button>
          <h4 class="modal-title" style="color:black">Editar um Fornecedor</h4>
        </div>
        <div class="modal-body">
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        ...
        <h4 class="modal-title">Excluir Fornecedores?</h4>
      </div>
      <div class="modal-body">
      ...
      <div class="modal-footer">
        ...
        <div id="carregaexcluir"  style="display:none;float:right;margin-right:-10px;margin-top:10px;">
                             ...
                             <div class="alert-success" id="excluirsucesso" style="font-size:14px;width:100%;height:30px;margin-top:10px;">
                                <strong>Fornecedor excluido com Sucesso!!!</strong>
                             </div>
...
function consultar_fornecedores()
	  {
		$("#carregando").hide();
		$("#carregar").hide(); 
		//var total    = $("#total").val();
